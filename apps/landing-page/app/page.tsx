/*
 * Vision Design — Atelier Zero landing page.
 *
    ...
    <>
      ...
      <div className='side-rail right' data-od-id='rail-right'>
        <span className='rail-text'>
          Vision Design — Vol. 01 · Issue Nº 26 · Apache-2.0
        </span>
      </div>
          ...
          <div className='container hero-grid'>
            ...
            <div className='hero-art' data-reveal='scale'>
              ...
              <span className='annot annot-br'>
                Composed in{NBSP}
                <span style={{ color: 'var(--coral)' }}>Vision Design</span>
              </span>
          ...
          <div className='container'>
            <div className='sec-rule'>
              ...
              <span className='meta-grp'>
                ...
                <span>Vision Design / Volume 01</span>
              </span>
              <span>002 / 008</span>
            </div>
          ...
          <div className='work'>
            <div className='work-rule'>
              ...
              <span style={{ display: 'inline-flex', gap: 24 }}>
                ...
                <span>Edited by Vision Design</span>
              </span>
              <span>006 / 008</span>
            </div>
            ...
            <div className='testimonial-grid'>
              <div className='testimonial-copy' data-reveal>
                ...
                <h2 style={{ marginTop: 30 }}>
                  &ldquo;Vision Design helped us turn vague <em>AI ideas</em> into
        ...
        <footer data-od-id='footer'>
          <div className='container'>
            <div className='foot-grid'>
              <div className='foot-brand'>
                ...
                <a
                  className='foot-cta'
                  href={REPO_RELEASES}
                  aria-label='Download the Vision Design desktop app'
                  {...ext}
                >
                  Download desktop
                  <span className='meta'>
            ...
            <div className='foot-bottom'>
              <span>
                <span className='pulse' />●{' '}
                <b style={{ color: 'var(--ink)' }}>Vision Design</b> · Apache-2.0
