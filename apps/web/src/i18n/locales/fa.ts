...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'Vision Design را راه‌اندازی کنید',
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به Vision Design، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Vision Design را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به Vision Design در GitHub ستاره بدهید',
  ...
  'connectors.emptyNoMatchAction': 'پاک کردن جستجو',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'متغیرها',
  'ds.modal.search': 'جستجو',
  'ds.modal.filter': 'فیلتر',
  'ds.modal.collections': 'مجموعه‌ها',
  'ds.modal.groups': 'گروه‌ها',
  'ds.modal.all': 'همه',
  'ds.modal.createVariable': 'ایجاد متغیر',
  'ds.modal.createCollection': 'ایجاد مجموعه',
  'ds.modal.createGroup': 'ایجاد گروه',
  'ds.modal.addMode': 'افزودن ستون',
  'ds.modal.renameMode': 'تغییر نام ستون',
  'ds.modal.deleteMode': 'حذف ستون',
  'ds.modal.deleteModeConfirm': 'ستون {name} حذف شود؟ مقادیر آن ستون از دست خواهند رفت.',
  'ds.modal.empty': 'هنوز متغیری وجود ندارد',
  'ds.modal.searchNoResults': 'هیچ متغیری با فیلتر مطابقت ندارد',
  'ds.modal.openShortcut': 'باز کردن سیستم طراحی',
  'ds.types.color': 'رنگ',
  'ds.types.number': 'عدد',
  'ds.types.string': 'رشته',
  'ds.types.boolean': 'بولی',
  'ds.surfaceLabel': 'سطح',
  'ds.surfaceWeb': 'وب',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Vision Design در حال اجراست و دوباره تلاش کنید.',
  ...
  'manualEdit.insert.text': "متن",
  'manualEdit.insert.shape': "شکل",
  'manualEdit.insert.toolbarLabel': "درج عنصر",
  'manualEdit.size.widthLabel': "عرض",
  'manualEdit.size.heightLabel': "ارتفاع",
  'manualEdit.size.fixed': "ثابت",
  'manualEdit.size.fill': "پر کردن",
  'manualEdit.size.hug': "محدود",
  'manualEdit.delete': "حذف",
  'manualEdit.deleteConfirm.title': "این عنصر حذف شود؟",
  'manualEdit.deleteConfirm.body': "این عمل عنصر را از طراحی حذف می‌کند. می‌توانید آن را از پنل تاریخچه بازگردانی کنید.",
  'manualEdit.deleteConfirm.cancel': "لغو",
  'manualEdit.deleteConfirm.confirm': "حذف",
  ...
  'fileViewer.codeEditor.title': 'کد',
  'fileViewer.codeEditor.area': 'ویرایشگر کد',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Vision Design — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Vision Design ارائه می‌شود — نیازی به دانلود نیست.',
