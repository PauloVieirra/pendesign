...
export const ko: Dict = {
  ...
  'settings.welcomeTitle': 'Vision Design 설정',
  ...
  'settings.agentInstall.pathHint':
    'npm 또는 Homebrew로 CLI를 설치했는데도 아직 미설치로 표시된다면, Vision Design daemon이 상속받는 PATH에 도구의 bin 디렉터리가 포함되어 있는지 확인하세요(macOS에서는 Terminal과 GUI 앱의 PATH가 다를 수 있습니다). QUICKSTART.md("Local agent CLI and PATH" 섹션)를 참고하세요.',
  'settings.agentInstall.stepOpenLinks': '원하는 에이전트 카드에서 설치 또는 문서 링크를 여세요.',
  'settings.agentInstall.stepAuth':
    'Vision Design으로 돌아오기 전에 공급자 CLI에서 인증(로그인 또는 API 자격 증명 추가)을 완료하세요.',
  ...
  'settings.mcpServerHint': 'Vision Design을 코딩 에이전트용 MCP 서버로 노출합니다.',
  ...
  'entry.githubStarAria': 'GitHub 에서 Vision Design 에 별 누르기',
  ...
  'connectors.emptyNoMatchAction': '검색 지우기',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.search': '검색',
  'ds.modal.filter': '필터',
  'ds.modal.collections': '컬렉션',
  'ds.modal.groups': '그룹',
  'ds.modal.all': '전체',
  'ds.modal.createVariable': '변수 만들기',
  'ds.modal.createCollection': '컬렉션 만들기',
  'ds.modal.createGroup': '그룹 만들기',
  'ds.modal.addMode': '열 추가',
  'ds.modal.renameMode': '열 이름 변경',
  'ds.modal.deleteMode': '열 삭제',
  'ds.modal.deleteModeConfirm': '{name} 열을 삭제하시겠습니까? 해당 열의 값이 사라집니다.',
  'ds.modal.empty': '변수가 아직 없습니다',
  'ds.modal.searchNoResults': '필터와 일치하는 변수가 없습니다',
  'ds.modal.openShortcut': '디자인 시스템 열기',
  'ds.types.color': '색상',
  'ds.types.number': '숫자',
  'ds.types.string': '문자열',
  'ds.types.boolean': '불리언',
  ...
  'preview.errorBody': '예제 HTML을 가져오지 못했습니다. Vision Design이 실행 중인지 확인하고 다시 시도하세요.',
  'preview.retry': '다시 시도',
  ...
  'manualEdit.insert.text': "텍스트",
  'manualEdit.insert.shape': "도형",
  'manualEdit.insert.toolbarLabel': "요소 삽입",
  'manualEdit.size.widthLabel': "너비",
  'manualEdit.size.heightLabel': "높이",
  'manualEdit.size.fixed': "고정",
  'manualEdit.size.fill': "채우기",
  'manualEdit.size.hug': "내용에 맞춤",
  'manualEdit.delete': "삭제",
  'manualEdit.deleteConfirm.title': "이 요소를 삭제하시겠습니까?",
  'manualEdit.deleteConfirm.body': "디자인에서 요소가 제거됩니다. 기록 패널에서 실행 취소할 수 있습니다.",
  'manualEdit.deleteConfirm.cancel': "취소",
  'manualEdit.deleteConfirm.confirm': "삭제",
  ...
  'fileViewer.codeEditor.title': '코드',
  'fileViewer.codeEditor.area': '코드 편집기',
  ...
  'pet.title': '펫',
  'pet.tabBuiltIn': '내장',
  'pet.tabBuiltInHint': 'Vision Design에 기본 포함된 친구들 — 골라서 입양하세요.',
  ...
  'pet.codexBundled': '내장',
  'pet.codexBundledTitle': 'Vision Design 에 내장 — 다운로드 불필요.',
  ...
  'settings.pixabay.description': '스톡 사진 검색 — pixabay.com/api에서 무료 키를 받으세요. 분당 100건 요청.',
