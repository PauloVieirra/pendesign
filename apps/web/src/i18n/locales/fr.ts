...
export const fr: Dict = {
  ...
  'connectors.emptyNoMatchAction': 'Effacer la recherche',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.search': 'Rechercher',
  'ds.modal.filter': 'Filtrer',
  'ds.modal.collections': 'Collections',
  'ds.modal.groups': 'Groupes',
  'ds.modal.all': 'Tous',
  'ds.modal.createVariable': 'Créer une variable',
  'ds.modal.createCollection': 'Créer une collection',
  'ds.modal.createGroup': 'Créer un groupe',
  'ds.modal.addMode': 'Ajouter une colonne',
  'ds.modal.renameMode': 'Renommer la colonne',
  'ds.modal.deleteMode': 'Supprimer la colonne',
  'ds.modal.deleteModeConfirm': 'Supprimer la colonne {name} ? Les valeurs de cette colonne seront perdues.',
  'ds.modal.empty': 'Aucune variable pour l\'instant',
  'ds.modal.searchNoResults': 'Aucune variable ne correspond au filtre',
  'ds.modal.openShortcut': 'Ouvrir le système de design',
  'ds.types.color': 'Couleur',
  'ds.types.number': 'Nombre',
  'ds.types.string': 'Chaîne',
  'ds.types.boolean': 'Booléen',
  ...
  'manualEdit.insert.text': "Texte",
  'manualEdit.insert.shape': "Forme",
  'manualEdit.insert.toolbarLabel': "Insérer un élément",
  'manualEdit.size.widthLabel': "Largeur",
  'manualEdit.size.heightLabel': "Hauteur",
  'manualEdit.size.fixed': "Fixe",
  'manualEdit.size.fill': "Remplir",
  'manualEdit.size.hug': "Ajuster",
  'manualEdit.delete': "Supprimer",
  'manualEdit.deleteConfirm.title': "Supprimer cet élément ?",
  'manualEdit.deleteConfirm.body': "Cela supprime l'élément du design. Vous pouvez l'annuler depuis le panneau d'historique.",
  'manualEdit.deleteConfirm.cancel': "Annuler",
  'manualEdit.deleteConfirm.confirm': "Supprimer",
  ...
  'fileViewer.codeEditor.area': 'Éditeur de code',
