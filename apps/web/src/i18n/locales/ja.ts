...
export const ja: Dict = {
  ...
  'settings.welcomeTitle': 'Vision Design を設定',
  ...
  'settings.agentInstall.pathHint':
    'npm または Homebrew で CLI をインストールしたのに未インストールのまま表示される場合は、Vision Design daemon が引き継ぐ PATH にツールの bin ディレクトリが含まれていることを確認してください（macOS では Terminal と GUI アプリで PATH が異なる場合があります）。QUICKSTART.md（"Local agent CLI and PATH" セクション）を参照してください。',
  'settings.agentInstall.stepOpenLinks': '利用したいエージェントの「インストール」または「ドキュメント」を開きます。',
  'settings.agentInstall.stepAuth':
    'Vision Design に戻る前に、ベンダー CLI で認証（サインインまたは API 資格情報の追加）を行います。',
  ...
  'settings.mcpServerHint': 'Vision Design を MCP サーバーとしてコーディングエージェントに公開します。',
  ...
  'entry.githubStarAria': 'GitHub で Vision Design にスターを付ける',
  ...
  'promptTemplates.retry': '再試行',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': '変数',
  'ds.modal.search': '検索',
  'ds.modal.filter': 'フィルター',
  'ds.modal.collections': 'コレクション',
  'ds.modal.groups': 'グループ',
  'ds.modal.all': 'すべて',
  'ds.modal.createVariable': '変数を作成',
  'ds.modal.createCollection': 'コレクションを作成',
  'ds.modal.createGroup': 'グループを作成',
  'ds.modal.addMode': '列を追加',
  'ds.modal.renameMode': '列の名前を変更',
  'ds.modal.deleteMode': '列を削除',
  'ds.modal.deleteModeConfirm': '列 {name} を削除しますか？その列の値は失われます。',
  'ds.modal.empty': '変数がまだありません',
  'ds.modal.searchNoResults': 'フィルターに一致する変数がありません',
  'ds.modal.openShortcut': 'デザインシステムを開く',
  'ds.types.color': 'カラー',
  'ds.types.number': '数値',
  'ds.types.string': '文字列',
  'ds.types.boolean': 'ブール値',
  ...
  'preview.errorBody': '例の HTML を取得できませんでした。Vision Design が起動していることを確認して再試行してください。',
  'preview.retry': '再試行',
  ...
  'manualEdit.insert.text': "テキスト",
  'manualEdit.insert.shape': "図形",
  'manualEdit.insert.toolbarLabel': "要素を挿入",
  'manualEdit.size.widthLabel': "幅",
  'manualEdit.size.heightLabel': "高さ",
  'manualEdit.size.fixed': "固定",
  'manualEdit.size.fill': "塗りつぶし",
  'manualEdit.size.hug': "コンテンツに合わせる",
  'manualEdit.delete': "削除",
  'manualEdit.deleteConfirm.title': "この要素を削除しますか?",
  'manualEdit.deleteConfirm.body': "デザインから要素を削除します。履歴パネルから元に戻すことができます。",
  'manualEdit.deleteConfirm.cancel': "キャンセル",
  'manualEdit.deleteConfirm.confirm': "削除",
  ...
  'fileViewer.codeEditor.title': 'コード',
  'fileViewer.codeEditor.area': 'コードエディタ',
  ...
  'pet.title': 'ペット',
  'pet.tabBuiltIn': '組み込み',
  'pet.tabBuiltInHint': 'Vision Design に同梱された厳選コンパニオン — 選んで迎え入れよう。',
  ...
  'pet.codexBundled': '同梱',
  'pet.codexBundledTitle': 'Vision Design に同梱 — ダウンロード不要。',
