...
export const esES: Dict = {
  ...
  'promptTemplates.retry': 'Reintentar',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.collections': 'Colecciones',
  'ds.modal.groups': 'Grupos',
  'ds.modal.all': 'Todos',
  'ds.modal.createVariable': 'Crear variable',
  'ds.modal.createCollection': 'Crear colección',
  'ds.modal.createGroup': 'Crear grupo',
  'ds.modal.addMode': 'Añadir columna',
  'ds.modal.renameMode': 'Renombrar columna',
  'ds.modal.deleteMode': 'Eliminar columna',
  'ds.modal.deleteModeConfirm': '¿Eliminar la columna {name}? Los valores de esa columna se perderán.',
  'ds.modal.empty': 'Aún no hay variables',
  'ds.modal.searchNoResults': 'Ninguna variable coincide con el filtro',
  'ds.modal.openShortcut': 'Abrir sistema de diseño',
  'ds.types.color': 'Color',
  'ds.types.number': 'Número',
  'ds.types.string': 'Cadena',
  ...
  'manualEdit.insert.toolbarLabel': "Insertar elemento",
  'manualEdit.size.widthLabel': "Ancho",
  'manualEdit.size.heightLabel': "Alto",
  'manualEdit.size.fixed': "Fijo",
  'manualEdit.size.fill': "Rellenar",
  'manualEdit.size.hug': "Ajustar",
  'manualEdit.delete': "Eliminar",
  'manualEdit.deleteConfirm.title': "¿Eliminar este elemento?",
  'manualEdit.deleteConfirm.body': "Esto eliminará el elemento del diseño. Puedes deshacerlo desde el panel de historial.",
  'manualEdit.deleteConfirm.cancel': "Cancelar",
  'manualEdit.deleteConfirm.confirm': "Eliminar",
  ...
  'settings.pixabay.label': 'Clave API de Pixabay',
  'settings.pixabay.description': 'Búsqueda de fotos stock — clave gratuita en pixabay.com/api. 100 solicitudes/minuto.',
  'settings.pixabay.placeholder': 'Tu clave API de Pixabay',
};
