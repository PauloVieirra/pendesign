...
export const ar: Dict = {
  ...
  'connectors.emptyNoMatchAction': 'مسح البحث',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'المتغيرات',
  'ds.modal.search': 'بحث',
  'ds.modal.filter': 'تصفية',
  'ds.modal.collections': 'المجموعات',
  'ds.modal.groups': 'الأقسام',
  'ds.modal.all': 'الكل',
  'ds.modal.createVariable': 'إنشاء متغير',
  'ds.modal.createCollection': 'إنشاء مجموعة',
  'ds.modal.createGroup': 'إنشاء قسم',
  'ds.modal.addMode': 'إضافة عمود',
  'ds.modal.renameMode': 'إعادة تسمية العمود',
  'ds.modal.deleteMode': 'حذف العمود',
  'ds.modal.deleteModeConfirm': 'حذف عمود {name}؟ ستُفقد القيم في هذا العمود.',
  'ds.modal.empty': 'لا توجد متغيرات بعد',
  'ds.modal.searchNoResults': 'لا توجد متغيرات تطابق الفلتر',
  'ds.modal.openShortcut': 'فتح نظام التصميم',
  'ds.types.color': 'لون',
  'ds.types.number': 'رقم',
  'ds.types.string': 'نص',
  'ds.types.boolean': 'منطقي',
  ...
  'manualEdit.insert.text': "نص",
  'manualEdit.insert.shape': "شكل",
  'manualEdit.insert.toolbarLabel': "إدراج عنصر",
  'manualEdit.size.widthLabel': "العرض",
  'manualEdit.size.heightLabel': "الارتفاع",
  'manualEdit.size.fixed': "ثابت",
  'manualEdit.size.fill': "ملء",
  'manualEdit.size.hug': "احتواء",
  'manualEdit.delete': "حذف",
  'manualEdit.deleteConfirm.title': "حذف هذا العنصر؟",
  'manualEdit.deleteConfirm.body': "سيؤدي ذلك إلى إزالة العنصر من التصميم. يمكنك التراجع عنه من لوحة السجل.",
  'manualEdit.deleteConfirm.cancel': "إلغاء",
  ...
  'fileViewer.codeEditor.title': 'الكود',
  'fileViewer.codeEditor.area': 'محرر الكود',
