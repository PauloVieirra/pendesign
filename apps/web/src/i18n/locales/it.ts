...
export const it: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Vision Design (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Vision Design.',
  ...
  'settings.mcpServerHint': 'Esponi Vision Design come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Vision Design',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Vision Design',
  'settings.privacyConsentLead': 'Vision Design può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'connectors.emptyNoMatchAction': 'Cancella ricerca',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'Variabili',
  'ds.modal.search': 'Cerca',
  'ds.modal.filter': 'Filtra',
  'ds.modal.collections': 'Collezioni',
  'ds.modal.groups': 'Gruppi',
  'ds.modal.all': 'Tutti',
  'ds.modal.createVariable': 'Crea variabile',
  'ds.modal.createCollection': 'Crea collezione',
  'ds.modal.createGroup': 'Crea gruppo',
  'ds.modal.addMode': 'Aggiungi colonna',
  'ds.modal.renameMode': 'Rinomina colonna',
  'ds.modal.deleteMode': 'Elimina colonna',
  'ds.modal.deleteModeConfirm': 'Eliminare la colonna {name}? I valori in quella colonna andranno persi.',
  'ds.modal.empty': 'Nessuna variabile ancora',
  'ds.modal.searchNoResults': 'Nessuna variabile corrisponde al filtro',
  'ds.modal.openShortcut': 'Apri design system',
  'ds.types.color': 'Colore',
  'ds.types.number': 'Numero',
  'ds.types.string': 'Stringa',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Vision Design sia in esecuzione e riprova.',
  ...
  'manualEdit.insert.text': 'Testo',
  'manualEdit.insert.shape': 'Forma',
  'manualEdit.insert.toolbarLabel': 'Inserisci elemento',
  'manualEdit.size.widthLabel': 'Larghezza',
  'manualEdit.size.heightLabel': 'Altezza',
  'manualEdit.size.fixed': 'Fisso',
  'manualEdit.size.fill': 'Riempi',
  'manualEdit.size.hug': 'Adatta',
  'manualEdit.delete': 'Elimina',
  'manualEdit.deleteConfirm.title': 'Eliminare questo elemento?',
  'manualEdit.deleteConfirm.body': 'Verrà rimosso l\'elemento dal design. Puoi annullarlo dal pannello della cronologia.',
  'manualEdit.deleteConfirm.cancel': 'Annulla',
  'manualEdit.deleteConfirm.confirm': 'Elimina',
  'fileViewer.zoomOut': 'Riduci zoom',
  'fileViewer.zoomIn': 'Aumenta zoom',
  'fileViewer.resetZoom': 'Reimposta zoom',
  'fileViewer.viewportAria': 'Viewport anteprima',
  ...
  'fileViewer.codeEditor.title': 'Codice',
  'fileViewer.codeEditor.area': 'Editor di codice',
  ...
  'fileViewer.viewportTabletTitle': 'Anteprima tablet a 820 × 1180 (baseline ritratto moderno)',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con Vision Design — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Vision Design — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': 'Vision Design v0.5 — editor di design guidato da chat',
  ...
  'settings.pixabay.label': 'Chiave API Pixabay',
  'settings.pixabay.description': 'Ricerca foto stock — chiave gratuita su pixabay.com/api. 100 richieste/minuto.',
  'settings.pixabay.placeholder': 'La tua chiave API Pixabay',
};
