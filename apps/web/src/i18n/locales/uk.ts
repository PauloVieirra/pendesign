...
export const uk: Dict = {
  ...
  'settings.welcomeTitle': 'Налаштування Vision Design',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon Vision Design (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до Vision Design.',
  ...
  'settings.mcpServerHint': 'Відкрийте Vision Design як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставити Vision Design зірку на GitHub',
  ...
  'connectors.emptyNoMatchAction': 'Очистити пошук',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'Змінні',
  'ds.modal.search': 'Пошук',
  'ds.modal.filter': 'Фільтр',
  'ds.modal.collections': 'Колекції',
  'ds.modal.groups': 'Групи',
  'ds.modal.all': 'Всі',
  'ds.modal.createVariable': 'Створити змінну',
  'ds.modal.createCollection': 'Створити колекцію',
  'ds.modal.createGroup': 'Створити групу',
  'ds.modal.addMode': 'Додати стовпець',
  'ds.modal.renameMode': 'Перейменувати стовпець',
  'ds.modal.deleteMode': 'Видалити стовпець',
  'ds.modal.deleteModeConfirm': 'Видалити стовпець {name}? Значення в цьому стовпці будуть втрачені.',
  'ds.modal.empty': 'Поки немає змінних',
  'ds.modal.searchNoResults': 'Жодна змінна не відповідає фільтру',
  'ds.modal.openShortcut': 'Відкрити дизайн-систему',
  'ds.types.color': 'Колір',
  'ds.types.number': 'Число',
  'ds.types.string': 'Рядок',
  'ds.types.boolean': 'Булевий',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що Vision Design запущено, і повторіть спробу.',
  ...
  'manualEdit.insert.text': "Текст",
  'manualEdit.insert.shape': "Фігура",
  'manualEdit.insert.toolbarLabel': "Вставити елемент",
  'manualEdit.size.widthLabel': "Ширина",
  'manualEdit.size.heightLabel': "Висота",
  'manualEdit.size.fixed': "Фіксований",
  'manualEdit.size.fill': "Заповнити",
  'manualEdit.size.hug': "За вмістом",
  'manualEdit.delete': "Видалити",
  'manualEdit.deleteConfirm.title': "Видалити цей елемент?",
  'manualEdit.deleteConfirm.body': "Це видалить елемент із дизайну. Ви можете скасувати дію через панель історії.",
  'manualEdit.deleteConfirm.cancel': "Скасувати",
  'manualEdit.deleteConfirm.confirm': "Видалити",
  ...
  'fileViewer.codeEditor.title': 'Код',
  'fileViewer.codeEditor.area': 'Редактор коду',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з Vision Design — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з Vision Design — завантаження не потрібне.',
  ...
  'settings.pixabay.description': 'Пошук стокових фото — безкоштовний ключ на pixabay.com/api. 100 запитів/хвилину.',
