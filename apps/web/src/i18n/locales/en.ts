...
export const en: Dict = {
  ...
  'settings.welcomeTitle': 'Set up Vision Design',
  ...
  'settings.agentInstall.pathHint':
    'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Vision Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth':
    'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Vision Design.',
  ...
  'settings.modelPickerFallbackHint':
    'Using Vision Design’s fallback model list because the installed CLI did not return live model metadata. Rescan after updating or logging in to the CLI.',
  ...
  'settings.mcpServerHint': 'Expose Vision Design as an MCP server for your coding agent.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Vision Design projects directly.',
  'settings.mcpDaemonError':
    "Couldn't reach the local daemon to resolve install paths ({error}). Make sure Vision Design is running, then reopen this panel.",
  ...
  'settings.mcpCapabilityDefault':
    'Default to the project and file you have open in Vision Design, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote':
    'Vision Design must be running for MCP tool calls to succeed. If you started your coding agent before opening Vision Design, restart the agent so it can reach the live daemon.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Vision Design plugin and add it to My plugins.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Vision Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Vision Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Vision Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Vision Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Vision Design everywhere',
  'useEverywhere.modalTitle': 'Use Vision Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop Vision Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Vision Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Vision Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Vision Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Vision Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Vision Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Vision Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Vision Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Vision Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Vision Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Vision Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Vision Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Vision Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Vision Design extras)',
  ...
  'entry.githubStarAria': 'Star Vision Design on GitHub',
  ...
  'connectors.emptyNoMatchAction': 'Clear search',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  'fileViewer.themeToggleToLight': 'Switch to light mode',
  ...
  'newproj.tabFigma': 'From Figma',
  'newproj.figma.intro': 'Generate a coded project from Figma. Paste your personal access token once, point to a page of screens, and optionally point to a second page that contains your reusable components.',
  'newproj.figma.patLabel': 'Figma personal access token',
  'newproj.figma.patPlaceholder': 'figd_…',
  'newproj.figma.patHint': 'Get one at figma.com → Settings → Personal access tokens. Saved to the figma-context MCP server.',
  'newproj.figma.patSaved': 'A token is already saved. Leave blank to keep it, or paste a new one to replace it.',
  'newproj.figma.screensUrlLabel': 'Figma page URL (screens)',
  'newproj.figma.screensUrlPlaceholder': 'https://www.figma.com/design/abc/Dashboard?node-id=10-2',
  'newproj.figma.componentsUrlLabel': 'Figma page URL (components, optional)',
  'newproj.figma.componentsUrlPlaceholder': 'https://www.figma.com/design/abc/Dashboard?node-id=20-5',
  'newproj.figma.outputFormatLabel': 'Output format',
  'newproj.figma.outputFormatReact': 'React + TypeScript',
  'newproj.figma.outputFormatHtml': 'HTML',
  'newproj.figma.cssFrameworkLabel': 'CSS framework',
  'newproj.figma.cssFrameworkTailwind': 'Tailwind',
  'newproj.figma.cssFrameworkBootstrap': 'Bootstrap',
  'newproj.figma.submit': 'Create from Figma',
  ...
  'importLocal.button': 'Import project',
  'importLocal.title': 'Import local project',
  'importLocal.subtitle': 'Copy a local folder into a new native project. A default design system and the standard project configuration are created automatically.',
  'importLocal.dropHint': 'Drag a project folder here, or',
  'importLocal.pick': 'Choose a folder',
  'importLocal.importing': 'Importing project…',
  'importLocal.errorGeneric': 'Could not import that folder. Please try again.',
  'importLocal.errorEmpty': 'That folder has no importable files.',
  'importLocal.cancel': 'Cancel',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Vision Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'manualEdit.insert.text': "Text",
  'manualEdit.insert.shape': "Shape",
  'manualEdit.insert.toolbarLabel': "Insert element",
  'manualEdit.size.widthLabel': "Width",
  'manualEdit.size.heightLabel': "Height",
  'manualEdit.size.fixed': "Fixed",
  'manualEdit.size.fill': "Fill",
  'manualEdit.size.hug': "Hug",
  'manualEdit.delete': "Delete",
  'manualEdit.deleteConfirm.title': "Delete this element?",
  'manualEdit.deleteConfirm.body': "This removes the element from the design. You can undo it from the history panel.",
  'manualEdit.deleteConfirm.cancel': "Cancel",
  'manualEdit.deleteConfirm.confirm': "Delete",
  ...
  'fileViewer.codeEditor.title': 'Code',
  'fileViewer.codeEditor.area': 'Code editor',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Vision Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Vision Design — no download needed.',
