...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройте Vision Design',
  ...
  'settings.agentInstall.pathHint':
    'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Vision Design (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Vision Design.',
  ...
  'settings.mcpServerHint': 'Откройте Vision Design как MCP-сервер для вашего кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставить Vision Design звезду на GitHub',
  ...
  'connectors.emptyNoMatchAction': 'Очистить поиск',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'Переменные',
  'ds.modal.search': 'Поиск',
  'ds.modal.filter': 'Фильтр',
  'ds.modal.collections': 'Коллекции',
  'ds.modal.groups': 'Группы',
  'ds.modal.all': 'Все',
  'ds.modal.createVariable': 'Создать переменную',
  'ds.modal.createCollection': 'Создать коллекцию',
  'ds.modal.createGroup': 'Создать группу',
  'ds.modal.addMode': 'Добавить столбец',
  'ds.modal.renameMode': 'Переименовать столбец',
  'ds.modal.deleteMode': 'Удалить столбец',
  'ds.modal.deleteModeConfirm': 'Удалить столбец {name}? Значения в этом столбце будут потеряны.',
  'ds.modal.empty': 'Переменных пока нет',
  'ds.modal.searchNoResults': 'Нет переменных, соответствующих фильтру',
  'ds.modal.openShortcut': 'Открыть дизайн-систему',
  'ds.types.color': 'Цвет',
  'ds.types.number': 'Число',
  'ds.types.string': 'Строка',
  'ds.types.boolean': 'Булев',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Vision Design запущен, и повторите попытку.',
  ...
  'manualEdit.insert.shape': "Фигура",
  'manualEdit.insert.toolbarLabel': "Вставить элемент",
  'manualEdit.size.widthLabel': "Ширина",
  'manualEdit.size.heightLabel': "Высота",
  'manualEdit.size.fixed': "Фиксированный",
  'manualEdit.size.fill': "Заполнить",
  'manualEdit.size.hug': "По содержимому",
  'manualEdit.delete': "Удалить",
  'manualEdit.deleteConfirm.title': "Удалить этот элемент?",
  'manualEdit.deleteConfirm.body': "Это удалит элемент из дизайна. Вы можете отменить это действие через панель истории.",
  'manualEdit.deleteConfirm.cancel': "Отмена",
  'manualEdit.deleteConfirm.confirm': "Удалить",
  ...
  'fileViewer.codeEditor.area': 'Редактор кода',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Vision Design — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Vision Design — загрузка не нужна.',
