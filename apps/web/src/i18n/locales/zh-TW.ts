...
export const zhTW: Dict = {
  ...
  'settings.agentInstall.pathHint':
    '如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 Vision Design daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。',
  'settings.agentInstall.stepOpenLinks': '在目標代理卡片上開啟「安裝」或「文件」連結。',
  'settings.agentInstall.stepAuth':
    '返回 Vision Design 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。',
  ...
  'settings.mcpServerHint': '將 Vision Design 作為 MCP 伺服器暴露給你的編碼代理。',
  ...
  'settings.privacy': '隱私',
  'settings.privacyHint': '與 Vision Design 團隊共享哪些資料',
  'settings.privacyConsentKicker': '協助我們改進 Vision Design',
  'settings.privacyConsentLead': 'Vision Design 可以將使用資料分享給我們的團隊以協助改進。包含:',
  ...
  'settings.mcpHint':
    '讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 Vision Design 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。',
  'settings.mcpDaemonError':
    '無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 Vision Design 正在執行，然後重新開啟此面板。',
  ...
  'settings.mcpCapabilityDefault':
    '預設使用您在 Vision Design 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。',
  'settings.mcpRunningNote':
    'Vision Design 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 Vision Design 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。',
  ...
  'entry.githubStarAria': '在 GitHub 為 Vision Design 點亮 Star',
  ...
  'connectors.emptyNoMatchAction': '清除搜尋',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.groups': '群組',
  'ds.modal.all': '全部',
  'ds.modal.createVariable': '建立變數',
  'ds.modal.createCollection': '建立集合',
  'ds.modal.createGroup': '建立群組',
  'ds.modal.addMode': '新增欄',
  'ds.modal.renameMode': '重新命名欄',
  'ds.modal.deleteMode': '刪除欄',
  'ds.modal.deleteModeConfirm': '刪除 {name} 欄？該欄中的值將會遺失。',
  'ds.modal.empty': '尚無變數',
  'ds.modal.searchNoResults': '沒有符合篩選條件的變數',
  'ds.modal.openShortcut': '開啟設計系統',
  'ds.types.color': '顏色',
  'ds.types.number': '數字',
  'ds.types.string': '字串',
  'ds.types.boolean': '布林值',
  'ds.surfaceLabel': '類型',
  'ds.surfaceWeb': '網頁',
  'ds.surfaceImage': '圖片',
  'ds.surfaceVideo': '影片',
  ...
  'preview.errorBody': '範例 HTML 載入失敗。請確認 Vision Design 正在執行後重試。',
  'preview.retry': '重試',
  ...
  'manualEdit.insert.text': "文字",
  'manualEdit.insert.shape': "形狀",
  'manualEdit.insert.toolbarLabel': "插入元素",
  'manualEdit.size.widthLabel': "寬度",
  'manualEdit.size.heightLabel': "高度",
  'manualEdit.size.fixed': "固定",
  'manualEdit.size.fill': "填滿",
  'manualEdit.size.hug': "自動調整",
  'manualEdit.delete': "刪除",
  'manualEdit.deleteConfirm.title': "刪除此元素？",
  'manualEdit.deleteConfirm.body': "這會從設計中移除該元素。您可以從歷史紀錄面板中復原。",
  'manualEdit.deleteConfirm.cancel': "取消",
  'manualEdit.deleteConfirm.confirm': "刪除",
  ...
  'fileViewer.codeEditor.title': '程式碼',
  'fileViewer.codeEditor.area': '程式碼編輯器',
  ...
  'pet.title': '寵物',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'Vision Design 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'Vision Design 內建寵物，無需下載。',
  ...
  'settings.memoryStarterProjectDesc': 'Vision Design v0.5 — 聊天驅動的設計編輯器',
