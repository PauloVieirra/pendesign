...
export const tr: Dict = {
  ...
  'settings.welcomeTitle': 'Vision Design kurulumu',
  ...
  'settings.agentInstall.pathHint':
    'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin Vision Design daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth':
    'Vision Design\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'Vision Design\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'entry.githubStarAria': 'Vision Design\u2019a GitHub üzerinde yıldız ver',
  ...
  'connectors.emptyNoMatchAction': 'Aramayı temizle',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'Değişkenler',
  'ds.modal.search': 'Ara',
  'ds.modal.filter': 'Filtrele',
  'ds.modal.collections': 'Koleksiyonlar',
  'ds.modal.groups': 'Gruplar',
  'ds.modal.all': 'Tümü',
  'ds.modal.createVariable': 'Değişken oluştur',
  'ds.modal.createCollection': 'Koleksiyon oluştur',
  'ds.modal.createGroup': 'Grup oluştur',
  'ds.modal.addMode': 'Sütun ekle',
  'ds.modal.renameMode': 'Sütunu yeniden adlandır',
  'ds.modal.deleteMode': 'Sütunu sil',
  'ds.modal.deleteModeConfirm': '{name} sütunu silinsin mi? O sütundaki değerler kaybolacak.',
  'ds.modal.empty': 'Henüz değişken yok',
  'ds.modal.searchNoResults': 'Filtreyle eşleşen değişken yok',
  'ds.modal.openShortcut': 'Design system\'i aç',
  'ds.types.color': 'Renk',
  'ds.types.number': 'Sayı',
  'ds.types.string': 'Metin',
  'ds.types.boolean': 'Mantıksal',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. Vision Design\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'fileViewer.codeEditor.area': 'Kod düzenleyici',
  ...
  'pet.tabBuiltInHint': 'Vision Design ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'Vision Design ile birlikte gelir — indirme gerekmez.',
