...
export const de: Dict = {
  ...
  'settings.welcomeTitle': 'Vision Design einrichten',
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu Vision Design zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle Vision Design als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.githubStarAria': 'Vision Design auf GitHub einen Stern geben',
  ...
  'promptTemplates.retry': 'Erneut versuchen',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'Variablen',
  'ds.modal.search': 'Suchen',
  'ds.modal.filter': 'Filtern',
  'ds.modal.collections': 'Sammlungen',
  'ds.modal.groups': 'Gruppen',
  'ds.modal.all': 'Alle',
  'ds.modal.createVariable': 'Variable erstellen',
  'ds.modal.createCollection': 'Sammlung erstellen',
  'ds.modal.createGroup': 'Gruppe erstellen',
  'ds.modal.addMode': 'Spalte hinzufügen',
  'ds.modal.renameMode': 'Spalte umbenennen',
  'ds.modal.deleteMode': 'Spalte löschen',
  'ds.modal.deleteModeConfirm': 'Spalte {name} löschen? Die Werte in dieser Spalte gehen verloren.',
  'ds.modal.empty': 'Noch keine Variablen',
  'ds.modal.searchNoResults': 'Keine Variablen entsprechen dem Filter',
  'ds.modal.openShortcut': 'Design-System öffnen',
  'ds.types.color': 'Farbe',
  'ds.types.number': 'Zahl',
  'ds.types.string': 'Zeichenkette',
  'ds.types.boolean': 'Boolesch',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass Vision Design läuft, und versuche es erneut.',
  ...
  'manualEdit.insert.shape': "Form",
  'manualEdit.insert.toolbarLabel': "Element einfügen",
  'manualEdit.size.widthLabel': "Breite",
  'manualEdit.size.heightLabel': "Höhe",
  'manualEdit.size.fixed': "Fest",
  'manualEdit.size.fill': "Ausfüllen",
  'manualEdit.size.hug': "Anpassen",
  'manualEdit.delete': "Löschen",
  'manualEdit.deleteConfirm.title': "Dieses Element löschen?",
  'manualEdit.deleteConfirm.body': "Dadurch wird das Element aus dem Design entfernt. Sie können dies über das Verlaufsfenster rückgängig machen.",
  'manualEdit.deleteConfirm.cancel': "Abbrechen",
  'manualEdit.deleteConfirm.confirm': "Löschen",
  ...
  'pet.tabBuiltInHint': 'Mit Vision Design gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit Vision Design ausgeliefert — kein Download nötig.',
  ...
  'settings.pixabay.label': 'Pixabay API-Schlüssel',
  'settings.pixabay.description': 'Stockfoto-Suche — kostenloser Schlüssel bei pixabay.com/api. 100 Anfragen/Minute.',
  'settings.pixabay.placeholder': 'Ihr Pixabay API-Schlüssel',
};
