...
export const pl: Dict = {
  ...
  'settings.welcomeTitle': 'Skonfiguruj Vision Design',
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon Vision Design (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do Vision Design.',
  ...
  'settings.mcpServerHint': 'Udostępnij Vision Design jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.githubStarAria': 'Daj Vision Design gwiazdkę na GitHubie',
  ...
  'connectors.emptyNoMatchAction': 'Wyczyść wyszukiwanie',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'Zmienne',
  'ds.modal.search': 'Szukaj',
  'ds.modal.filter': 'Filtruj',
  'ds.modal.collections': 'Kolekcje',
  'ds.modal.groups': 'Grupy',
  'ds.modal.all': 'Wszystkie',
  'ds.modal.createVariable': 'Utwórz zmienną',
  'ds.modal.createCollection': 'Utwórz kolekcję',
  'ds.modal.createGroup': 'Utwórz grupę',
  'ds.modal.addMode': 'Dodaj kolumnę',
  'ds.modal.renameMode': 'Zmień nazwę kolumny',
  'ds.modal.deleteMode': 'Usuń kolumnę',
  'ds.modal.deleteModeConfirm': 'Usunąć kolumnę {name}? Wartości w tej kolumnie zostaną utracone.',
  'ds.modal.empty': 'Brak zmiennych',
  'ds.modal.searchNoResults': 'Żadna zmienna nie pasuje do filtru',
  'ds.modal.openShortcut': 'Otwórz system projektowy',
  'ds.types.color': 'Kolor',
  'ds.types.number': 'Liczba',
  'ds.types.string': 'Tekst',
  'ds.types.boolean': 'Wartość logiczna',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że Vision Design jest uruchomiony, i spróbuj ponownie.',
  ...
  'fileViewer.codeEditor.title': 'Kod',
  'fileViewer.codeEditor.area': 'Edytor kodu',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do Vision Design — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z Vision Design — bez pobierania.',
  ...
  'settings.pixabay.label': 'Klucz API Pixabay',
  'settings.pixabay.description': 'Wyszukiwanie zdjęć stockowych — bezpłatny klucz na pixabay.com/api. 100 żądań/minutę.',
  'settings.pixabay.placeholder': 'Twój klucz API Pixabay',
};
