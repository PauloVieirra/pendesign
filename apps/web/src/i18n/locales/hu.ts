...
export const hu: Dict = {
  ...
  'connectors.emptyNoMatchAction': 'Keresés törlése',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'Változók',
  'ds.modal.search': 'Keresés',
  'ds.modal.filter': 'Szűrés',
  'ds.modal.collections': 'Gyűjtemények',
  'ds.modal.groups': 'Csoportok',
  'ds.modal.all': 'Összes',
  'ds.modal.createVariable': 'Változó létrehozása',
  'ds.modal.createCollection': 'Gyűjtemény létrehozása',
  'ds.modal.createGroup': 'Csoport létrehozása',
  'ds.modal.addMode': 'Oszlop hozzáadása',
  'ds.modal.renameMode': 'Oszlop átnevezése',
  'ds.modal.deleteMode': 'Oszlop törlése',
  'ds.modal.deleteModeConfirm': 'Törli a(z) {name} oszlopot? Az oszlopban lévő értékek elvesznek.',
  'ds.modal.empty': 'Még nincsenek változók',
  'ds.modal.searchNoResults': 'Nincs a szűrőnek megfelelő változó',
  'ds.modal.openShortcut': 'Design rendszer megnyitása',
  'ds.types.color': 'Szín',
  'ds.types.number': 'Szám',
  'ds.types.string': 'Szöveg',
  'ds.types.boolean': 'Logikai',
  ...
  'fileViewer.codeEditor.title': 'Kód',
  'fileViewer.codeEditor.area': 'Kódszerkesztő',
