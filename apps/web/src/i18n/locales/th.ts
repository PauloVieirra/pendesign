...
export const th: Dict = {
  ...
  'settings.welcomeTitle': 'ตั้งค่า Vision Design',
  ...
  'settings.agentInstall.pathHint':
    'หากคุณติดตั้ง CLI ด้วย npm หรือ Homebrew แล้วแต่ยังแสดงว่าไม่ได้ติดตั้ง โปรดตรวจสอบว่าโฟลเดอร์ bin ของเครื่องมือนั้นอยู่ใน PATH ที่ Vision Design daemon ใช้งาน (บน macOS ค่า PATH ของ Terminal และแอป GUI อาจต่างกัน) ดู QUICKSTART.md (ส่วน "Local agent CLI and PATH")',
  'settings.agentInstall.stepOpenLinks': 'เปิดลิงก์ติดตั้งหรือเอกสารสำหรับเอเจนต์ที่ต้องการ',
  'settings.agentInstall.stepAuth':
    'ยืนยันตัวตนกับ CLI ของผู้ให้บริการ (ลงชื่อเข้าใช้หรือเพิ่มข้อมูลรับรอง API) ก่อนกลับไปที่ Vision Design',
  ...
  'settings.mcpServerHint': 'เปิดให้ Vision Design เป็นเซิร์ฟเวอร์ MCP สำหรับเอเจนต์โค้ด',
  ...
  'settings.privacyHint': 'ข้อมูลที่แชร์กับทีม Vision Design',
  'settings.privacyConsentKicker': 'ช่วยเราพัฒนา Vision Design',
  'settings.privacyConsentLead': 'Vision Design สามารถแชร์ข้อมูลการใช้งานกับทีมของเราเพื่อช่วยพัฒนา ซึ่งรวมถึง:',
  ...
  'connectors.emptyNoMatchAction': 'ล้างการค้นหา',  'fileViewer.themeToggleToDark': 'Switch to dark mode',
  ...
  'ds.modal.title': 'ตัวแปร',
  'ds.modal.search': 'ค้นหา',
  'ds.modal.filter': 'กรอง',
  'ds.modal.collections': 'คอลเลกชัน',
  'ds.modal.groups': 'กลุ่ม',
  'ds.modal.all': 'ทั้งหมด',
  'ds.modal.createVariable': 'สร้างตัวแปร',
  'ds.modal.createCollection': 'สร้างคอลเลกชัน',
  'ds.modal.createGroup': 'สร้างกลุ่ม',
  'ds.modal.addMode': 'เพิ่มคอลัมน์',
  'ds.modal.renameMode': 'เปลี่ยนชื่อคอลัมน์',
  'ds.modal.deleteMode': 'ลบคอลัมน์',
  'ds.modal.deleteModeConfirm': 'ลบคอลัมน์ {name}? ค่าในคอลัมน์นั้นจะสูญหาย',
  'ds.modal.empty': 'ยังไม่มีตัวแปร',
  'ds.modal.searchNoResults': 'ไม่มีตัวแปรที่ตรงกับตัวกรอง',
  'ds.modal.openShortcut': 'เปิดดีไซน์ซิสเต็ม',
  'ds.types.color': 'สี',
  'ds.types.number': 'ตัวเลข',
  'ds.types.string': 'ข้อความ',
  'ds.types.boolean': 'บูลีน',
  ...
  'fileViewer.viewportAria': 'วิวพอร์ตพรีวิว',
  ...
  'fileViewer.codeEditor.title': 'โค้ด',
  'fileViewer.codeEditor.area': 'โปรแกรมแก้ไขโค้ด',
  ...
  'fileViewer.viewportTabletTitle': 'พรีวิวแท็บเล็ตที่ 820 × 1180',
  'fileViewer.viewportMobile': 'มือถือ',
  'fileViewer.viewportMobileTitle': 'พรีวิวมือถือที่ 390 × 844',
  ...
  'pet.tabBuiltInHint': 'จัดกลุ่มให้พร้อมใช้กับชุดระบบจาก Vision Design แล้ว — เอาได้เลย',
  ...
  'pet.codexBundledTitle': 'เตรียมมาให้กับ Vision Design แล้ว — ไม่ต้องดาวน์โหลดใหม่',
