...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o Vision Design',
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do Vision Design (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao Vision Design.',
  ...
  'settings.mcpServerHint': 'Exponha o Vision Design como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao Vision Design no GitHub',
  ...
  'connectors.emptyNoMatchAction': 'Limpar busca',  'fileViewer.themeToggleToDark': 'Modo escuro',
  'fileViewer.themeToggleToLight': 'Modo claro',
  ...
  'newproj.tabFigma': 'A partir do Figma',
  'newproj.figma.intro': 'Gere um projeto em código a partir do Figma. Cole seu token de acesso pessoal uma vez, aponte para uma página com as telas e, opcionalmente, para uma segunda página com a biblioteca de componentes.',
  'newproj.figma.patLabel': 'Token de acesso pessoal do Figma',
  'newproj.figma.patPlaceholder': 'figd_…',
  'newproj.figma.patHint': 'Gere em figma.com → Settings → Personal access tokens. Salvo no servidor MCP figma-context.',
  'newproj.figma.patSaved': 'Já existe um token salvo. Deixe em branco para mantê-lo, ou cole um novo para substituir.',
  'newproj.figma.screensUrlLabel': 'URL da página do Figma (telas)',
  'newproj.figma.screensUrlPlaceholder': 'https://www.figma.com/design/abc/Dashboard?node-id=10-2',
  'newproj.figma.componentsUrlLabel': 'URL da página do Figma (componentes, opcional)',
  'newproj.figma.componentsUrlPlaceholder': 'https://www.figma.com/design/abc/Dashboard?node-id=20-5',
  'newproj.figma.outputFormatLabel': 'Formato de saída',
  'newproj.figma.outputFormatReact': 'React + TypeScript',
  'newproj.figma.outputFormatHtml': 'HTML',
  'newproj.figma.cssFrameworkLabel': 'Framework de CSS',
  'newproj.figma.cssFrameworkTailwind': 'Tailwind',
  'newproj.figma.cssFrameworkBootstrap': 'Bootstrap',
  'newproj.figma.submit': 'Criar a partir do Figma',
  ...
  'importLocal.button': 'Importar projeto',
  'importLocal.title': 'Importar projeto local',
  'importLocal.subtitle': 'Copie uma pasta local para um novo projeto nativo. Um design system padrão e a configuração padrão do projeto são criados automaticamente.',
  'importLocal.dropHint': 'Arraste uma pasta de projeto aqui, ou',
  'importLocal.pick': 'Escolher pasta',
  'importLocal.importing': 'Importando projeto…',
  'importLocal.errorGeneric': 'Não foi possível importar essa pasta. Tente novamente.',
  'importLocal.errorEmpty': 'Essa pasta não tem arquivos importáveis.',
  'importLocal.cancel': 'Cancelar',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o Vision Design está em execução e tente novamente.',
  ...
  'manualEdit.insert.text': "Texto",
  'manualEdit.insert.shape': "Forma",
  'manualEdit.insert.toolbarLabel': "Inserir elemento",
  'manualEdit.size.widthLabel': "Largura",
  'manualEdit.size.heightLabel': "Altura",
  'manualEdit.size.fixed': "Fixo",
  'manualEdit.size.fill': "Preencher",
  'manualEdit.size.hug': "Ajustar",
  'manualEdit.delete': "Excluir",
  'manualEdit.deleteConfirm.title': "Excluir este elemento?",
  'manualEdit.deleteConfirm.body': "Isso remove o elemento do design. Você pode desfazer pelo painel de histórico.",
  'manualEdit.deleteConfirm.cancel': "Cancelar",
  'manualEdit.deleteConfirm.confirm': "Excluir",
  ...
  'fileViewer.codeEditor.title': 'Código',
  'fileViewer.codeEditor.area': 'Editor de código',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Vision Design — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Vision Design — sem download.',
  ...
  'settings.pixabay.description': 'Busca de fotos stock — chave gratuita em pixabay.com/api. 100 requisições/minuto.',
