...
const PLUGIN_SHARE_DETAILS: Record<PluginShareAction, {
  ...
  'publish-github': {
    ...
    fallbackDescription:
      'Creates a public GitHub repository for this local Vision Design plugin.',
    confirmLabel: 'Start publishing',
    steps: [
      'Create a new Vision Design project for the publish workflow.',
  ...
  'contribute-open-design': {
    eyebrow: 'Vision Design pull request',
    fallbackTitle: 'Contribute Plugin to Vision Design',
    fallbackDescription:
      'Opens a pull request that adds this plugin to the Vision Design community catalog.',
    confirmLabel: 'Start contribution',
    steps: [
      'Create a new Vision Design project for the contribution workflow.',
      'Copy this plugin into that project as isolated source context.',
