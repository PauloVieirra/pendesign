...
// into Vision Design, create new artifacts, ship downstream framework
...
const PRIMARY_CATEGORIES: readonly CategoryDef[] = [
  {
    slug: 'import',
    label: 'Import',
    starterPrompt: 'Create an Vision Design plugin that imports a source into a project and normalizes it into editable artifacts.',
    test: isSourcePlugin,
  },
  {
    slug: 'create',
    label: 'Create',
    starterPrompt: 'Create an Vision Design plugin that generates a reusable artifact from a short user brief.',
    test: isCreatePlugin,
  },
  {
    slug: 'export',
    label: 'Export',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact into a downstream file or framework handoff.',
    test: isExportPlugin,
  },
  {
    slug: 'share',
    label: 'Share',
    starterPrompt: 'Create an Vision Design plugin that packages an accepted artifact for sharing with collaborators.',
    test: isSharePlugin,
  },
  {
    slug: 'deploy',
    label: 'Deploy',
    starterPrompt: 'Create an Vision Design plugin that deploys an accepted artifact to a hosted downstream surface.',
    test: isDeployPlugin,
  },
  {
    slug: 'refine',
    label: 'Refine',
    starterPrompt: 'Create an Vision Design plugin that reviews, patches, and improves an existing artifact.',
    test: isRefinePlugin,
  },
  {
    slug: 'extend',
    label: 'Extend',
    starterPrompt: 'Create an Vision Design plugin that extends the Vision Design plugin catalog or authoring workflow.',
    test: isExtendPlugin,
  },
];
...
const SUBCATEGORIES: readonly SubcategoryDef[] = [
  {
    ...
    slug: 'from-figma',
    label: 'Figma',
    starterPrompt: 'Create an Vision Design plugin that imports a Figma file or frame URL and rebuilds it as editable Vision Design artifacts.',
  ...
  },
  {
    ...
    slug: 'from-github',
    label: 'GitHub',
    starterPrompt: 'Create an Vision Design plugin that imports a GitHub repository or path, discovers the design entrypoints, and prepares an editable workspace.',
  ...
  },
  {
    ...
    slug: 'from-code',
    label: 'Code / folder',
    starterPrompt: 'Create an Vision Design plugin that imports a local code folder and turns the relevant UI into an editable design artifact.',
  ...
  },
  {
    ...
    slug: 'from-url',
    label: 'URL',
    starterPrompt: 'Create an Vision Design plugin that imports a public URL, captures the page structure, and recreates it as an editable artifact.',
  ...
  },
  {
    ...
    label: 'Screenshot',
    starterPrompt: 'Create an Vision Design plugin that imports a screenshot or image reference and reconstructs a matching editable UI.',
  ...
  },
  {
    ...
    slug: 'from-pdf',
    label: 'PDF',
    starterPrompt: 'Create an Vision Design plugin that imports a PDF and converts key pages into editable Vision Design artifacts.',
  ...
  },
  {
    ...
    slug: 'from-pptx',
    label: 'PPTX',
    starterPrompt: 'Create an Vision Design plugin that imports a PPTX deck and converts slides into editable deck artifacts.',
  ...
  },
  {
    ...
    slug: 'from-framer',
    label: 'Framer',
    starterPrompt: 'Create an Vision Design plugin that imports a Framer site or project export and rebuilds it as editable components.',
  ...
  },
  {
    ...
    slug: 'from-webflow',
    label: 'Webflow',
    starterPrompt: 'Create an Vision Design plugin that imports a Webflow site export and maps it into editable Vision Design artifacts.',
  ...
  },
  {
    ...
    slug: 'prototype',
    label: 'Prototype',
    starterPrompt: 'Create an Vision Design plugin that generates an interactive prototype from a product brief.',
  ...
  },
  {
    ...
    slug: 'deck',
    label: 'Slides',
    starterPrompt: 'Create an Vision Design plugin that generates a polished slide deck from a narrative brief.',
    test: byMode('deck'),
  },
  {
    parent: 'create',
    slug: 'design-system',
    label: 'Design system',
    starterPrompt: 'Create an Vision Design plugin that generates a reusable design system from brand and product constraints.',
  ...
  },
  {
    ...
    slug: 'hyperframes',
    label: 'HyperFrames',
    starterPrompt: 'Create an Vision Design plugin that generates a HyperFrames-ready motion composition.',
  ...
  },
  {
    ...
    slug: 'image',
    label: 'Image',
    starterPrompt: 'Create an Vision Design plugin that generates image assets from structured creative direction.',
    test: byMode('image'),
  },
  {
    parent: 'create',
    slug: 'video',
    label: 'Video',
    starterPrompt: 'Create an Vision Design plugin that generates video prompts, storyboards, or render-ready motion artifacts.',
    test: byMode('video'),
  },
  {
    parent: 'create',
    slug: 'audio',
    label: 'Audio',
    starterPrompt: 'Create an Vision Design plugin that generates audio, voice, or sound-design assets from a brief.',
    test: byMode('audio'),
  },
  {
    parent: 'export',
    slug: 'pptx',
    label: 'PPTX',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted deck artifact to PPTX with high visual fidelity.',
    test: byAnySlugPart('pptx', 'ppt'),
  },
  {
    parent: 'export',
    slug: 'pdf',
    label: 'PDF',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to a polished PDF package.',
    test: byAnySlugPart('pdf'),
  },
  {
    parent: 'export',
    slug: 'html',
    label: 'HTML',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to standalone HTML.',
    test: byAnySlug('html'),
  },
  {
    parent: 'export',
    slug: 'zip',
    label: 'ZIP',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact as a portable ZIP bundle.',
    test: byAnySlug('zip'),
  },
  {
    parent: 'export',
    slug: 'markdown',
    label: 'Markdown',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to Markdown with asset references.',
  ...
  },
  {
    ...
    slug: 'figma',
    label: 'Figma',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact into a Figma-ready handoff package.',
  ...
  },
  {
    ...
    slug: 'nextjs',
    label: 'Next.js',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to a Next.js App Router implementation.',
  ...
  },
  {
    ...
    slug: 'reactjs',
    label: 'React.js',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to a React component handoff.',
  ...
  },
  {
    ...
    slug: 'vuejs',
    label: 'Vue.js',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to a Vue single-file component.',
  ...
  },
  {
    ...
    slug: 'sveltejs',
    label: 'Svelte.js',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to a Svelte component.',
  ...
  },
  {
    ...
    slug: 'astro',
    label: 'Astro',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to an Astro component or page.',
  ...
  },
  {
    ...
    slug: 'angular',
    label: 'Angular',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact to an Angular component.',
  ...
  },
  {
    ...
    slug: 'tailwind',
    label: 'Tailwind',
    starterPrompt: 'Create an Vision Design plugin that exports an accepted artifact using Tailwind CSS classes.',
  ...
  },
  {
    ...
    slug: 'public-link',
    label: 'Public link',
    starterPrompt: 'Create an Vision Design plugin that publishes an accepted artifact to a shareable public link.',
  ...
  },
  {
    ...
    slug: 'github-pr',
    label: 'GitHub PR',
    starterPrompt: 'Create an Vision Design plugin that opens a GitHub pull request with the accepted artifact changes.',
  ...
  },
  {
    ...
    slug: 'github-gist',
    label: 'GitHub Gist',
    starterPrompt: 'Create an Vision Design plugin that publishes an accepted artifact as a GitHub Gist.',
  ...
  },
  {
    ...
    slug: 'slack',
    label: 'Slack',
    starterPrompt: 'Create an Vision Design plugin that shares an accepted artifact summary and link to Slack.',
  ...
  },
  {
    ...
    slug: 'discord',
    label: 'Discord',
    starterPrompt: 'Create an Vision Design plugin that shares an accepted artifact summary and link to Discord.',
  ...
  },
  {
    ...
    slug: 'notion',
    label: 'Notion',
    starterPrompt: 'Create an Vision Design plugin that publishes an accepted artifact and notes into Notion.',
  ...
  },
  {
    ...
    slug: 'linear',
    label: 'Linear',
    starterPrompt: 'Create an Vision Design plugin that posts an accepted artifact update to a Linear issue.',
  ...
  },
  {
    ...
    slug: 'jira',
    label: 'Jira',
    starterPrompt: 'Create an Vision Design plugin that posts an accepted artifact update to a Jira ticket.',
    test: byAnySlug('jira'),
  },
  {
    parent: 'deploy',
    slug: 'vercel',
    label: 'Vercel',
    starterPrompt: 'Create an Vision Design plugin that deploys an accepted web artifact to Vercel and returns preview and production links.',
  ...
  },
  {
    ...
    slug: 'cloudflare',
    label: 'Cloudflare',
    starterPrompt: 'Create an Vision Design plugin that deploys an accepted web artifact to Cloudflare Pages.',
  ...
  },
  {
    ...
    slug: 'netlify',
    label: 'Netlify',
    starterPrompt: 'Create an Vision Design plugin that deploys an accepted web artifact to Netlify.',
  ...
  },
  {
    ...
    slug: 'github-pages',
    label: 'GitHub Pages',
    starterPrompt: 'Create an Vision Design plugin that deploys an accepted static artifact to GitHub Pages.',
  ...
  },
  {
    ...
    slug: 'fly-io',
    label: 'Fly.io',
    starterPrompt: 'Create an Vision Design plugin that deploys an accepted app artifact to Fly.io.',
  ...
  },
  {
    ...
    slug: 'render',
    label: 'Render',
    starterPrompt: 'Create an Vision Design plugin that deploys an accepted app artifact to Render.',
  ...
  },
  {
    ...
    slug: 'docker',
    label: 'Docker',
    starterPrompt: 'Create an Vision Design plugin that packages an accepted app artifact into a Docker-ready handoff.',
  ...
  },
  {
    ...
    slug: 'tune',
    label: 'Tune',
    starterPrompt: 'Create an Vision Design plugin that tunes an existing artifact based on user feedback.',
  ...
  },
  {
    ...
    slug: 'review',
    label: 'Review',
    starterPrompt: 'Create an Vision Design plugin that reviews an existing artifact and proposes concrete fixes.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Vision Design plugin that helps users author, validate, and install new Vision Design plugins.',
