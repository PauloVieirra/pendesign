...
//   - Copy markdown badge     (Vision Design powered, includes link)
...
function buildMarkdownBadge(record: InstalledPluginRecord): string {
  ...
  return `[![${record.title} — Vision Design plugin](https://img.shields.io/badge/Open%20Design-${encodeURIComponent(record.title)}-d65a31?logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2C)](${url})`;
}
