  ...
  it('confirms a plugin share action before starting the GitHub repo task', async () => {
    mockedListPlugins.mockResolvedValue([
      ...
      makePlugin(
        ...
        'Creates a public GitHub repository for a local Vision Design plugin using the GitHub CLI.',
      ),
      makePlugin(
        'od-plugin-contribute-open-design',
        'bundled',
        'bundled',
        'Contribute Plugin to Vision Design',
        'Opens a pull request that adds a local Vision Design plugin to the Vision Design community catalog.',
      ),
    ]);
