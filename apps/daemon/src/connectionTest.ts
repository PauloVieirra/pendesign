...
function codexExecutableGuidance(
  ...
  return ` Configured Codex path failed: ${configuredOverridePath}. Vision Design also detected a PATH Codex CLI at ${pathResolvedPath}. Update CODEX_BIN or clear the custom path to use the detected binary.`;
}
