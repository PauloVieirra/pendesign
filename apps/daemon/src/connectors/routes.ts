...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Vision Design</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Vision Design">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">Vision Design</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Vision Design.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Vision Design.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Vision Design.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Vision Design.';
        }
