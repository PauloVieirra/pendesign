...
describe('LEAN_INCEPTION_SYSTEM_PROMPT_V1', () => {
  it('mentions all 12 column keys', () => {
    const p = LEAN_INCEPTION_SYSTEM_PROMPT_V1;
    for (const key of ['vision', 'problem', 'objective', 'csd_matrix', 'market_research', 'market_opportunities', 'personas', 'user_journey', 'features', 'business_rules', 'ideation', 'acceptance_criteria']) {
